<div id="tab-search-results" style="display: none;" class="composer-card">
    <div style="display: flex; justify-content: space-between; align-items: center; border-bottom: 1px solid var(--border-color); padding-bottom: 12px; margin-bottom: 20px;">
        <h2 style="font-size: 18px; margin: 0;">🔍 Resultados de búsqueda</h2>
        <button onclick="showTab('feed')" style="width: auto; padding: 6px 12px; font-size: 13px; display: inline-flex; align-items: center; margin: 0; box-shadow: none; background: rgba(255,255,255,0.06);">← Volver</button>
    </div>
